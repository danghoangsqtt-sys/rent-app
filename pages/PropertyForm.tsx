...
// Added optional user prop
const PropertyForm: React.FC<{ user?: any }> = () => {
  const { id } = useParams();
            ...
            {formData.hasTenant && (
              <div className="space-y-6 animate-in zoom-in-95">
                ...
                <section className="bg-white p-5 rounded-3xl border border-slate-100 shadow-sm space-y-4">
                  <h4 className="text-[10px] font-black text-slate-400 uppercase tracking-widest flex items-center gap-2 mb-2"><Calendar size={14}/> Chu kỳ thanh toán</h4>
